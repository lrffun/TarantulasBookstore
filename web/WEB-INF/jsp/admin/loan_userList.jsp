...
<div class="panel panel-default">
            ...
            <div class="col-md-1">
                ...
                <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                    ...
                    <div class="modal-dialog">
                        <form action="/admin/loan_addUser"  method="post">
                            <div class="modal-content">
                                ...
                                <div class="modal-body" align="center">
                                    学&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;号：<input type="text" name="id"/><br/><br/>
                                    密&nbsp;&nbsp;&nbsp;&nbsp;码：<input type="text" name="password"/><br/><br/>
                                    姓&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;名：<input type="text" name="name"/><br/><br/>
                                    性&nbsp;&nbsp;&nbsp;&nbsp;别：<input type="text" name="sex"/><br/><br/>
                                    年&nbsp;&nbsp;&nbsp;&nbsp;龄：<input type="text" name="age"/><br/><br/>
                                    所在院系：<input type="text" name="college"/><br/><br/>
                                    所在班级：<input type="text" name="sclass"/><br/><br/>
                                </div>
    ...
    <div class="col-md-1">
        <select class="form-control">
            ...
            <form action="/admin/selectStudentByName.action" method="post">
                <div class="col-md-3">
                    <input type="text" name="name" class="form-control input-md" placeholder="请输入您想搜索的学生姓名">
                </div>
                <div class="col-md-1">
                ...
                <c:forEach items="${userList}" var="useList">
                    <tr>
                        ...
                        <td><a href="/admin/loan_editUser.action?id=${useList.id}">
                            ...
                            <a href="/admin/addBlackList?id=${useList.id}">
                                <button class="btn btn-danger"><span class="glyphicon glyphicon-trash"> </span> 加入黑名单
                                </button>
                            </a>
                        </td>
                    </tr>
