...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <form method="post" action="/admin/TarantulasBookstore/OrderBorrow.action">
            <div class="row">
                <div class="col-md-3">
                    <input id="xuehao" type="text" name="id" class="form-control input-md" placeholder="请输入借阅学生学号"/>
                </div>
                <div class="col-md-3">
