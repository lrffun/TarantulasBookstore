...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <div class="row">
            <form name="searchForm" action="/admin/loan/searchLoanList.action" method="post">
                <div class="col-sm-1" style="width: 11.33%;">
                    <div class="form-group">
                        <select class="form-control" name="searchSelect">
                            <option value="stu_id">借阅人学号</option>
                            <option value="stu_name">借阅人姓名</option>
                            <option value="book_id">图书编号</option>
                            <option value="book_name">图书名称</option>
                            <option value="borrow_date">借阅时间</option>
                            <option value="sreturn_date">归还时间</option>
                        </select>
                    </div>
                </div>
                <div class="col-md-3">
