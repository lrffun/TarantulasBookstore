...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <form method="post" action="/admin/TarantulasBookstore/Borrow.action?id=${id}">
            <div class="row">
                <div class="col-md-3">
                    <input id="xuehao" type="text" name="id" disabled="true" class="form-control input-md" placeholder="${id}"/>
                </div>
                <div class="col-md-3">
