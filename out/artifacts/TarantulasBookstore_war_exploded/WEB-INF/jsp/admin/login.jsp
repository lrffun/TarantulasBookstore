	...
	<body>
		...
		<div class="layui-fluid">
			<div class="layui-row layui-col-space15">
				<div class="layui-col-sm12 layui-col-md12 zyl_mar_01">
					<blockquote class="layui-elem-quote">狼蛛图书管理系统</blockquote>
				</div>
			</div>
		</div>
		<!-- Head End -->
		...
		<div class="zyl_lofo_main">
			<fieldset class="layui-elem-field layui-field-title zyl_mar_02">
				<legend>欢迎登陆 - 狼蛛图书管理系统</legend>
			</fieldset>
			<div class="layui-row layui-col-space15">
				<form class="layui-form zyl_pad_01" action="/checkLogin" method="post">
					<div class="layui-col-sm12 layui-col-md12">
						<div class="layui-form-item">
							<input type="text" name="id" lay-verify="required|userName" autocomplete="off" placeholder="账号" class="layui-input">
					...
					<div class="layui-col-sm12 layui-col-md12">
						<button class="layui-btn layui-btn-fluid" type="submit" lay-filter="demo1">立即登录</button>
					</div>
				</form>
			</div>
		</div>
